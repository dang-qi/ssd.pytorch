...
base = {
    '128': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'C', 512, 512, 512, 'M',
            512, 512, 512],
    '256': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'C', 512, 512, 512, 'M',
            512, 512, 512],
...
extras = {
    '128': [256, 'S', 512, 128, 'S', 256],
    '256': [256, 'S', 512, 128, 'S', 256, 128, 256],
...
mbox = {
    '128': [4, 6, 6, 6],  # number of boxes per feature map location
    '256': [4, 6, 6, 6, 4],  # number of boxes per feature map location
